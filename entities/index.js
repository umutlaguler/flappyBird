...
export default restart => {
    let engine = Matter.Engine.create({enableSleeping: false}) //creates the engine from Matter library

    let world = engine.world //create the game world

    world.gravity.y = 0.4; //set the gravity of the game world
